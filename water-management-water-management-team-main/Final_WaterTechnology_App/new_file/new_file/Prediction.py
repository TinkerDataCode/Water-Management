...
recent_data = pd.read_csv(r"D:/Case_study/CaseStudy_app/new_file/new_file/recent_weather_data.csv")
...
model_path = r"D:/Case_study/CaseStudy_app/new_file/new_file/"
model = load_model(model_path)

with open(r"D:/Case_study/CaseStudy_app/new_file/new_file/scaler_X.pkl", 'rb') as file:
    scaler_X = pickle.load(file)

with open(r"D:/Case_study/CaseStudy_app/new_file/new_file/scaler_y.pkl", 'rb') as file:
    scaler_y = pickle.load(file)

with open(r"D:/Case_study/CaseStudy_app/new_file/new_file/target_cols.pkl", 'rb') as file:
